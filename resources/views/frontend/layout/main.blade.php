...
<head>
  ...
  <!-- Custom Stylesheet -->
  <link rel="stylesheet" href="{{ asset('assets-fe/assets/theme/css/custom.css') }}">
...
<!-- Bootstrap5 Bundle with Popper -->
<script src="{{ asset('assets-fe/assets/theme/plugins/bootstrap/bootstrap.bundle.min.js') }}"></script>
<!-- Parallax -->
